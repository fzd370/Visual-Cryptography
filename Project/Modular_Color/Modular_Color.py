...
if __name__ == "__main__":
  ...
  for idx in range(share_size):
    ...
    name = "./Shares/Modular_Share_" + str(idx+1) + ".jpg"
    image.save(name)

  output_image = decrypt(shares)

  output_image.save("./Output/Output_Modular.jpg")
  print("Decrypted image has been saved in the output folder")
  input_image.save("./Output/Input_Modular.jpg")
  
  print("Evaluation metrics : ")
  MSE = performance.MSE(inputfile, "./Output/Output_Modular.jpg")
  print("MSE = " + str(MSE))
  PSNR = performance.PSNR(inputfile, "./Output/Output_Modular.jpg")
  print("PSNR = " + str(PSNR))
  
  img=cv.imread("Output/Input_Modular.jpg")
  img1=cv.imread('Output/Output_Modular.jpg')
